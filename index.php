...
<?php
    ...
    $query_tracks = $pdo->query("SELECT * FROM music ORDER BY id DESC LIMIT 6");
    $tracks = $query_tracks->fetchAll(PDO::FETCH_ASSOC);

    $query_videos = $pdo->query("SELECT * FROM videos ORDER BY id DESC LIMIT 3");
...
<?php head(); ?>
    ...
    <!-- Hero Section Begin -->
    <section class="hero spad set-bg" data-setbg="template/img/hero-bg.png">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="event__slider owl-carousel">
                    <div class="col-lg-4">
                        <div class="event__item">
                            <div class="event__item__pic set-bg" data-setbg="template/img/events/event-1.jpg">
                                <div class="tag-date">
                    ...
                    <div class="col-lg-4">
                        <div class="event__item">
                            <div class="event__item__pic set-bg" data-setbg="template/img/events/event-2.jpg">
                                <div class="tag-date">
                                    <span>Dec 15, 2019</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="event__item">
                            <div class="event__item__pic set-bg" data-setbg="template/img/events/event-3.jpg">
                                <div class="tag-date">
                                    <span>Dec 15, 2019</span>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about__pic">
                        <img src="template/img/about/about.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="services__left set-bg" data-setbg="template/img/services/service-left.jpg">
                    ...
                    <div class="row services__list">
                        <div class="col-lg-6 p-0 order-lg-1 col-md-6 order-md-1">
                            <div class="service__item deep-bg">
                                <img src="template/img/services/service-1.png" alt="">
                                <h4>Wedding</h4>
                        ...
                        <div class="col-lg-6 p-0 order-lg-2 col-md-6 order-md-2">
                            <div class="service__item">
                                <img src="template/img/services/service-2.png" alt="">
                                <h4>Clubs and bar</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 p-0 order-lg-4 col-md-6 order-md-4">
                            <div class="service__item deep-bg">
                                <img src="template/img/services/service-4.png" alt="">
                                <h4>DJ lessons</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 p-0 order-lg-3 col-md-6 order-md-3">
                            <div class="service__item">
                                <img src="template/img/services/service-3.png" alt="">
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="track__all">
                        <a href="tracks.php" class="primary-btn border-btn">View all tracks</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-7 p-0">
                    ...
                    <!-- audio player -->
                        <div class="single_player_container">
                            <h4>David Guetta Miami Ultra</h4>
                            <div class="jp-jplayer jplayer" data-ancestor=".jp_container_1_1"
                                data-url="template/music-files/1.mp3"></div>
                            <div class="jp-audio jp_container_1_1" role="application" aria-label="media player">
                        ...
                        <?php foreach ($tracks as $item) { ?>
                            <div class="single_player_container">
                                <h4><?php echo ucwords($item['title']); ?></h4>
                                <div class="jp-jplayer jplayer" data-ancestor=".jp_container_<?php echo $item['id']; ?>"
                                    data-url="uploads/audio/<?php echo $item['source']; ?>"></div>
                                <div class="jp-audio jp_container_<?php echo $item['id']; ?>" role="application" aria-label="media player">
                                    <div class="jp-gui jp-interface">
                                        <!-- Player Controls -->
                                        <div class="player_controls_box">
                                            <button class="jp-play player_button" tabindex="0"></button>
                        ...
                        <!-- <div class="single_player_container">
                            ...
                            <div class="jp-jplayer jplayer" data-ancestor=".jp_container_2"
                                data-url="template/music-files/2.mp3"></div>
                        ...
                        <div class="single_player_container">
                            ...
                            <div class="jp-jplayer jplayer" data-ancestor=".jp_container_3"
                                data-url="template/music-files/3.mp3"></div>
                        ...
                        <div class="single_player_container">
                            ...
                            <div class="jp-jplayer jplayer" data-ancestor=".jp_container_4"
                                data-url="template/music-files/4.mp3"></div>
                        ...
                        <div class="single_player_container">
                            ...
                            <div class="jp-jplayer jplayer" data-ancestor=".jp_container_5"
                                data-url="template/music-files/5.mp3"></div>
                        ...
                        <div class="single_player_container">
                            ...
                            <div class="jp-jplayer jplayer" data-ancestor=".jp_container_6"
                                data-url="template/music-files/6.mp3"></div>
                ...
                <div class="col-lg-5 p-0">
                    <div class="track__pic">
                        <img src="template/img/track-right.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="youtube spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="track__all">
                        <a href="videos.php" class="primary-btn border-btn">View all videos</a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="youtube__item">
                        <div class="youtube__item__pic set-bg" data-setbg="template/img/youtube/youtube-1.jpg">
                ...
                <!-- <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="youtube__item">
                        <div class="youtube__item__pic set-bg" data-setbg="template/img/youtube/youtube-2.jpg">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="youtube__item">
                        <div class="youtube__item__pic set-bg" data-setbg="template/img/youtube/youtube-3.jpg">
    ...
    <section class="countdown spad set-bg" data-setbg="template/img/countdown-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
...
<!-- script for opacity effect in navbar -->
<script type="text/javascript">
  document.getElementById('header_nav').classList.remove('header--normal');
  document.getElementById('foot').classList.remove('footer--normal');
</script>
